    ...
    public class GamesDataStore : IDataStore<Item>
    {
        ...
        public GamesDataStore()
        {
            ...
            var games = new List<Item>
            {
                ...
                new Item { Id = Guid.NewGuid().ToString(), Image = "wednesday.png", Text = "Wednesday", Cart = new WednesdayCard(),Description="Serial wednesday." },
                //new Item { Id = Guid.NewGuid().ToString(), Image = "fortnite.jpg", Text = "Fortnite", Cart = new FortniteCard(), Description="Pexeso ze světa Fortnite" },
                //new Item { Id = Guid.NewGuid().ToString(), Image = "fortnite.jpg", Text = "Fortnite", Cart = new FortniteCard(), Description="Pexeso ze světa Fortnite" },
